  ...
  return (
    <div className="hero-section">
                ...
                <ul className="flex items-center gap-6 text-sm">
                  {navigateLeft.map((nav, index) => {
                    ...
                    return (
                      <li key={index}>
                        <Link
                          className="capitalize text-white transition hover:text-white/80"
                          to={url}
                        >
                          {page}
                        </Link>
      ...
      <div className="container mx-auto">
        <div className="p-12 lg:pt-10 xl:p-28 space-y-4 xl:space-y-8">
          <h1 className="text-4xl md:text-6xl capitalize font-semibold text-white">
            <span className="text-red-600">autoSud</span> - drive <br /> with
            confidence
          </h1>
          <p className="text-white/50 text-xs md:text-base w-96">
            Our experienced and certified technicians are dedicated to providing
            you with the highest quality repairs, So you can feel safe and
            secure on the road.
          </p>
